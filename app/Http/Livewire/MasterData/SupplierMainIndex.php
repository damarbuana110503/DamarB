...
class SupplierMainIndex extends Component
{
    ...
    {
        $getData = Supplier::orderBy('FK_SUP', 'ASC')->paginate(2);
    ...
    public function createData()
    {
        $this->validate([
            ...
            'state.FNOTELP' => 'required|string',
            'state.FALAMAT' => 'required|string',
            'state.FCONTACT' => 'required|string',
        ], [
    ...
    public function updateData()
    {
        $this->validate([
            ...
            'unique' => 'Data / Input Dengan Data Tersebut Sudah Ada !',
            'string' => 'Input Harus Berupa Alphanumerik !',
            'exists' => 'Data Tidak valid,  silahakan Pilih ulang !',
        ]);
