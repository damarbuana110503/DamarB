...
use App\Models\RelasiBarangSupplier as ModelsRelasiBarangSupplier;
use App\Models\Supplier;
use Illuminate\Support\Facades\DB;
use Livewire\Component;
use Livewire\WithPagination;

class RelasiBarangSupplier extends Component
{
    ...
    {
        return view('livewire.master-data.relasi-barang-supplier');
    }
    ...
    public function openModalSupplier()
    {
        $this->emitTo('master-data.supplier-modal-data', 'openModalSupplier', [
            'showProps' => 'show',
            'source' => 'master-data.relasi-barang-supplier',
        ]);
    }
    ...
    {
        try {
            $checkRelasi = ModelsRelasiBarangSupplier::where('FK_SUP', '=', $this->supplier)
            ->where('FK_BRG', '=', $idBarang)->first();
    ...
    public function createData()
    {
        ...
        try {
            ...
            $createData = ModelsRelasiBarangSupplier::create([
            ...
            DB::commit();
            $this->emit('success', 'Data Relasi Berhasil Di-Tambahkan !');
    ...
    public function updateData()
    {
        ...
        try {
            $getData = ModelsRelasiBarangSupplier::where('FKD_RLS', '=', $this->state['FKD_RLS'])->firstOrFail();
            $getSupplier = Supplier::where('FK_SUP', '=', $this->supplier['FK_SUP'])->firstOrFail();
            $getBarang = Barang::where('FK_BRG', '=', $this->barang['FK_BRG'])->firstOrFail();
