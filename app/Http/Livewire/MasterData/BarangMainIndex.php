...
class BarangMainIndex extends Component
{
    ...
    {
        $getData = Barang::orderBy('FK_BRG', 'ASC')->paginate(2);
    ...
    public function showForm($show, $data = [])
    {
        ...
        if ($data != null) {
            ...
            if ($data['satuan'] != null) {
                ...
                $this->state['TEXT_SAT'] = $data['satuan']['FK_SAT']. ' - ' . $data['satuan']['FN_SAT'];
            }
    ...
    public function selectedSatuan($data)
    {
        if ($data != null) {
            ...
            $this->satuan = $data;
            $this->state['FK_SAT'] = $data['FK_SAT'];
            $this->state['TEXT_SAT'] = $data['FK_SAT'] . ' - ' . $data['FN_SAT'];
        }
    }
    ...
    public function updateData()
    {
        ...
        try {
            ...
            DB::commit();
            $this->emit('info', 'Data Berhasil Di-Ubah !');
            $this->showForm(false);
        } catch (\Exception $e) {
            $this->emit('error', 'Terjadi Kesalahan ! <br> Silahkan Hubungi Administrator !');
            dd($e);
